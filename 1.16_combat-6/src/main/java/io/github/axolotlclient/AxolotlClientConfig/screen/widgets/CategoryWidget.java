...
public class CategoryWidget extends OptionWidget {
	...
	public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.visible) {
            ...
            this.hovered = mouseX >= this.x && mouseY >= this.y && mouseX < this.x + this.width && mouseY < this.y + this.height && !(enabledButton!=null && enabledButton.isHovered()) || isFocused();
	...
	protected MutableText getNarrationMessage() {
		return new LiteralText(category.getTranslatedName()).append(super.getNarrationMessage());
	}
}
