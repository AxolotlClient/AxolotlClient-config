...
public class ColorSelectionScreen extends io.github.axolotlclient.AxolotlClientConfig.impl.ui.Screen {
	...
	public void init() {
		...
		if (this.height - 250 > 0) {
			TextFieldWidget text = new TextFieldWidget(client.textRenderer, buttonsX, 190, 150, 20, LiteralText.EMPTY);
	...
	public void render(MatrixStack graphics, int mouseX, int mouseY, float delta) {
		...
		drawTextWithShadow(graphics, client.textRenderer, new TranslatableText("option.chroma"), buttonsX, 105, Colors.WHITE.toInt());
		drawTextWithShadow(graphics, client.textRenderer, new TranslatableText("option.alpha"), buttonsX, 150, Colors.WHITE.toInt());
	}
