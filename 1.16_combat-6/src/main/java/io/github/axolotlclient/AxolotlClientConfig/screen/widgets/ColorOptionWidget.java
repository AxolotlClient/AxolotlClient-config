...
public class ColorOptionWidget extends OptionWidget {
	...
	protected MutableText getNarrationMessage() {
		return new LiteralText(option.getTranslatedName()).append(super.getNarrationMessage()).append(new TranslatableText("narration.value").append(option.get().toString())).append("Press Enter to open color picker.");
	}

    @Override
    protected void onFocusedChanged(boolean newFocused) {
        textField.setFocusUnlocked(newFocused);
    }
