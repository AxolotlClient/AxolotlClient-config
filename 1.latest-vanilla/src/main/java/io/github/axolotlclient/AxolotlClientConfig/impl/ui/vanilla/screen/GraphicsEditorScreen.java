...
public class GraphicsEditorScreen extends Screen {
	...
	public void init() {
		...
		addRenderableWidget(Button.builder(Component.translatable("clear_graphics"),
				buttonWidget -> clearGraphics())
			.width(100).pos(gridX + maxGridWidth + 10, gridY + 60).build());
		...
		addRenderableWidget(Button.builder(CommonComponents.GUI_BACK, buttonWidget -> onClose())
			.pos(width / 2 - 75, height - 30).build());
	}
	...
	public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
		...
		graphics.drawCenteredString(minecraft.font, this.title, width / 2, 20, -1);
		...
		graphics.drawString(minecraft.font, Component.translatable("option.current"),
